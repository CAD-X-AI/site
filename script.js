...
setTimeout(showRange, 2000);

setTimeout(showDesign, 4000);

setTimeout(showFuture, 6000);
...
document.addEventListener("visibilitychange", () => {
   if (document.hidden) {
     ...
     clear()
     document.getElementById("type").innerHTML = "De Futuro Ipsum";
     show()
      // tab is active
   }
});
